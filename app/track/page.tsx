  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      if (result) {
        ...
        setError(
          "No feedback found with this access code. Please check and try again."
        );
        setFeedback(null);
      }
    } catch (err) {
      ...
      <div className="container mx-auto px-4 max-w-2xl">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Enter your anonymous access code to view the status and any
              follow-up questions
            </CardDescription>
          </CardHeader>
          <CardContent>
                ...
                <div className="bg-slate-50 rounded-xl p-6">
                  ...
                  <div className="mt-6">
                    <div className="flex items-center justify-between">
                      {["received", "in-progress", "resolved"].map(
                        (step, idx) => {
                          const isActive = feedback.status === step;
                          const isPast =
                            ["received", "in-progress", "resolved"].indexOf(
                              feedback.status
                            ) >= idx;
                          return (
                            <div key={step} className="flex items-center">
                              <div className="flex flex-col items-center">
                                ...
                                <div className="text-xs text-slate-600 mt-2 text-center whitespace-nowrap">
                                  {step === "received"
                                    ? "Received"
                                    : step === "in-progress"
                                    ? "In Progress"
                            ...
                            {clarification.response ? (
                              ...
                              <div className="space-y-3">
                                <Textarea
                                  ...
                                  value={
                                    clarificationResponses[clarification.id] ||
                                    ""
                                  }
                                  onChange={(e) =>
